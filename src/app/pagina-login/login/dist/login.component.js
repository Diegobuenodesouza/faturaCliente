...
var usuario_1 = require("./../../_model/usuario");
var LoginComponent = /** @class */ (function () {
    function LoginComponent(autenticacao) {
        this.autenticacao = autenticacao;
        this.formulario = new forms_1.FormGroup({
            email: new forms_1.FormControl(null, [forms_1.Validators.required]),
            senha: new forms_1.FormControl(null, [forms_1.Validators.required])
        });
    }
    LoginComponent.prototype.ngOnInit = function () {
    };
    LoginComponent.prototype.autenticar = function () {
        var usuario = new usuario_1.Usuario(this.formulario.value.email, this.formulario.value.senha);
